...
const USE_CASES = [
  {
    ...
    items: ['처음 만난 날부터 D-day 카운트', '100일·200일·1주년 기념일 날짜', '결혼기념일까지 남은 날 계산', '두 사람의 띠·별자리 궁합 확인'],
  },
  {
    icon: '📚', title: '수험생 · 학생',
    color: 'from-sky-400 to-blue-400',
    bg: 'bg-sky-50', border: 'border-sky-100', titleColor: 'text-sky-600',
    items: ['수능·시험까지 D-day 계산', '원서 마감일까지 영업일 확인', '학기 시작·종강일 날짜 계산', '만 나이로 학년·병역 기준 확인'],
  },
  {
    icon: '💼', title: '직장인 · 비즈니스',
    color: 'from-emerald-400 to-green-400',
    bg: 'bg-emerald-50', border: 'border-emerald-100', titleColor: 'text-emerald-600',
    items: ['세전 월급 → 실수령액 계산', '계약 만료일·프로젝트 마감 영업일', '입사일 기준 근속 기간 확인', '연봉 협상 전 공제 내역 파악'],
  },
  {
    icon: '💪', title: '건강 · 다이어트',
    color: 'from-orange-400 to-rose-400',
    bg: 'bg-orange-50', border: 'border-orange-100', titleColor: 'text-orange-600',
    items: ['BMI · 적정 체중 범위 확인', '기초대사량·하루 필요 칼로리 계산', '감량·유지·증량 목표별 식단 기준', '다이어트 시작일 D-day 관리'],
  },
  {
    icon: '🌸', title: '여성 · 임신 준비',
    color: 'from-pink-400 to-fuchsia-400',
    bg: 'bg-fuchsia-50', border: 'border-fuchsia-100', titleColor: 'text-fuchsia-600',
    items: ['다음 생리 예정일 미리 확인', '배란일·가임기 날짜 예측', 'PMS 예상 기간 파악', '향후 4개월 주기 한눈에 보기'],
  },
  {
    icon: '🔄', title: '일상 · 생활',
    color: 'from-teal-400 to-cyan-400',
    bg: 'bg-teal-50', border: 'border-teal-100', titleColor: 'text-teal-600',
    items: ['cm ↔ 인치, kg ↔ 파운드 즉시 변환', '평 ↔ m² 아파트 넓이 계산', '섭씨 ↔ 화씨 온도 변환', '해외 레시피 용량 단위 변환'],
  },
]
...
function buildJsonLd() {
  ...
  return { '@context': 'https://schema.org', '@type': 'ItemList', name: '생활 계산기 목록', url: `${BASE_URL}/`, itemListElement: items }
}
