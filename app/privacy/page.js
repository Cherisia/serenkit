export const metadata = {
  title: '개인정보처리방침',
  description: 'Toolit 서비스의 개인정보처리방침을 안내합니다.',
  robots: { index: false, follow: true },
  alternates: { canonical: 'https://toolit.com/privacy/' },
}

const SECTIONS = [
  {
    title: '1. 수집하는 개인정보',
    content: `Toolit은 별도의 회원가입 없이 이용 가능한 서비스로, 사용자로부터 직접적인 개인정보(이름, 이메일, 전화번호 등)를 수집하지 않습니다.
...
• 맞춤형 광고 제공 (Google AdSense)`,
  },
  {
    ...
    content: `Toolit은 서비스 이용 편의 및 광고 최적화를 위해 쿠키를 사용합니다.
...
• Google AdSense: 관심 기반 광고 노출`,
  },
  {
    ...
    content: `Toolit은 Google LLC가 제공하는 Google Analytics 및 Google AdSense를 사용합니다. 이 과정에서 Google은 쿠키를 통해 사용자의 서비스 이용 행태 및 관심사 정보를 수집할 수 있습니다.
...
• 맞춤 광고 설정 관리: https://adssettings.google.com`,
  },
  {
    ...
    content: `Toolit은 개인정보를 목적 달성 후 지체 없이 파기합니다. Google Analytics 등 제3자 서비스의 데이터 보유 기간은 각 서비스의 정책을 따릅니다.`,
  },
  {
    title: '6. 미성년자 보호',
    content: `Toolit은 만 14세 미만 아동으로부터 의도적으로 개인정보를 수집하지 않습니다. 만약 보호자가 자녀의 정보가 수집되었다고 판단하시는 경우, 아래 연락처로 문의해 주시면 즉시 삭제 조치하겠습니다.`,
  },
  {
    title: '7. 개인정보 관련 문의',
    ...
    <div className="w-full bg-slate-50 pb-20">
      ...
      <main className="container xl:w-7/12 md:w-9/12 w-[92%] mx-auto mt-10 space-y-8">
        ...
        <p className="bg-amber-50 border border-amber-100 rounded-2xl p-6 text-xs text-stone-600 leading-relaxed">
          Toolit(이하 "서비스")은 사용자의 개인정보를 중요하게 생각합니다. 본 방침은 서비스 이용 과정에서 수집되는 정보의 종류와 사용 방식을 안내합니다.
        </p>
