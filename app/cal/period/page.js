...
export const metadata = {
  ...
  description: '마지막 생리 시작일을 입력하면 다음 생리 예정일, 배란일, 가임기, PMS 예상일, 향후 4개월 주기를 자동으로 계산해드립니다.',
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: '/api/og?title=생리주기+계산기&sub=다음+생리+예정일+배란일+가임기+예측', width: 1200, height: 630, alt: '생리주기 계산기 | serenkit' }],
  },
}
...
const jsonLd = {
  ...
  name: '생리주기 계산기',
  url: 'https://serenkit.com/cal/period/',
  description: '마지막 생리 시작일 기준으로 다음 생리 예정일, 배란일, 가임기, PMS를 계산하는 무료 계산기',
...
const faqs = [
  ...
  { q: 'PMS란 무엇인가요?', a: 'PMS(월경전증후군, Premenstrual Syndrome)는 생리 전 7~14일 동안 나타나는 신체적·정서적 증상입니다. 복부 팽만, 두통, 예민함, 피로감 등이 흔하며 생리가 시작되면 대부분 완화됩니다.' },
  { q: '생리주기가 불규칙해요. 계산기가 맞지 않을 수 있나요?', a: '네, 이 계산기는 주기가 일정하다는 가정 하에 계산합니다. 주기가 불규칙하다면 실제 날짜와 다를 수 있어요. 불규칙한 주기가 지속된다면 산부인과 상담을 권장합니다.' },
