...
export const metadata = {
  title: '생리주기 계산기 — 다음 생리 예정일·배란일·가임기 즉시 계산',
  description: '마지막 생리 시작일을 입력하면 다음 생리 예정일, 배란일, 가임기, PMS 예상일, 향후 4개월 주기를 자동으로 계산해요.',
  keywords: ['생리주기 계산기', '다음 생리 예정일', '배란일 계산기', '가임기 계산', '생리 예측', '생리 계산기', 'PMS 예상일', '생리주기 예측', '생리 예정일 계산', '월경 주기 계산기'],
  alternates: { canonical: 'https://serenkit.com/cal/period/' },
  openGraph: {
    title: '생리주기 계산기 — 다음 생리 예정일·배란일·가임기 즉시 계산 | serenkit',
