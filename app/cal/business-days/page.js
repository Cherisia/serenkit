...
export const metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: '/api/og?title=영업일+계산기&sub=주말+공휴일+제외+실제+근무일+계산', width: 1200, height: 630, alt: '영업일 계산기 | serenkit' }],
  },
}
...
const faqs = [
  ...
  { q: '영업일과 달력상 일수는 어떻게 다른가요?', a: '달력상 일수는 주말과 공휴일을 포함한 전체 날수이고, 영업일은 실제 업무가 이루어지는 날수입니다. 예를 들어 10 영업일은 주말 포함 시 약 2주에 해당합니다.' },
  { q: '공휴일 데이터는 어느 기간까지 포함되어 있나요?', a: '현재 2025년~2026년 대한민국 공휴일이 포함되어 있습니다. 임시 공휴일 등 추가로 지정되는 공휴일은 반영이 늦어질 수 있으니 중요한 일정은 반드시 확인하세요.' },
  { q: '공휴일을 제외하지 않고 계산할 수도 있나요?', a: '네, 한국 공휴일 제외 체크박스를 해제하면 주말만 제외하고 공휴일은 포함해서 계산합니다.' },
  { q: '배송 예정일 계산에 활용할 수 있나요?', a: '네, 주문일을 시작일로 설정하고 영업일 수를 확인하면 실제 배송 가능일을 예측하는 데 도움이 됩니다. 단 배송사마다 기준이 다를 수 있으니 참고용으로 활용하세요.' },
]
