...
export const metadata = {
  title: '적정 체중 계산기 — BMI·비만도·표준 체중 즉시 확인',
  ...
  openGraph: {
    title: '적정 체중 계산기 — BMI·비만도·표준 체중 즉시 확인 | serenkit',
    description: 'BMI와 표준 체중으로 나의 적정 체중 범위를 확인해보세요.',
    url: 'https://serenkit.com/cal/weight/',
    type: 'website',
    images: [{ url: '/og-image.png?v=2', width: 1200, height: 630, alt: '적정 체중 계산기 - serenkit' }],
  },
}
